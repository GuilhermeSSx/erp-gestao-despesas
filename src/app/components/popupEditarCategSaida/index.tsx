...
const PopupEditarCategSaida: React.FC<PopupProps> = ({ open, onClose, saidaNome, saidaId }) => {
    const [inputValue, setInputValue] = useState(saidaNome);

    useEffect(() => {
        if (!open) {
            setInputValue(saidaNome);
        }
    }, [open, saidaNome]);
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className='sm:w-[60%] md:w-[30%] w-full h-76 items-center bg-white z-20 p-3 rounded-xl'>
                    <div className='rounded-lg w-full p-1 '>
                        ...
                        />
                        <h2 className="mt-3 text-base font-bold text-center">{saidaNome}, {saidaId}</h2>
                    </div>
                    ...
                    <div className='flex justify-between mt-4'>
                        ...
                        <button
                            onClick={() => {
                                ...
                                console.log(`Editar tipo com ID ${saidaId}`);
                            }}
                            title="Editar"
...
export default PopupEditarCategSaida;
