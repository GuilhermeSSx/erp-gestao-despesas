...
const PopupExcluirCentroCusto: React.FC<PopupProps> = ({ open, onClose, centroCustoId, centroCustoNome }) => {
    return (
            ...
            <div className="flex flex-col items-center justify-center h-full p-4">
                ...
                <div className='sm:w-[60%] md:w-[30%] w-full h-76 items-center bg-white z-20 p-3 rounded-xl'>
                    <div className=' rounded-lg w-full p-1 '>
                        ...
                        <h2 className="mt-3 text-base font-bold text-center">{centroCustoId}, {centroCustoNome}</h2>
                    </div>
                    ...
                    <div className='flex justify-between mt-4'>
                        ...
                        <button title="Excluir" className='mt-2 group relative w-[50%] flex justify-center items-center py-1 px-4 border border-transparent
...
export default PopupExcluirCentroCusto;
