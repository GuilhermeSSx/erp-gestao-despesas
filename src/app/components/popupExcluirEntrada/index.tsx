...
const PopupExcluirEntrada: React.FC<PopupProps> = ({ open, onClose, entradaId, entradaNome }) => {
    return (
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className='sm:w-[60%] md:w-[30%] w-full h-76 items-center bg-white z-20 p-3 rounded-xl'>
                    <div className=' rounded-lg w-full p-1 '>
                        ...
                        <h2 className="mt-3 text-base font-bold text-center">{entradaId}, {entradaNome}</h2>
                    </div>
...
export default PopupExcluirEntrada;
