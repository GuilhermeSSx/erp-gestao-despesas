...
const TableFavorecidos: React.FC<TableFavorecidosProps> = ({ favorecidos }) => {

    const { setSelectedFavorecido } = useFavorecido();
                ...
                <div className='rounded-lg h-full w-[100%] overflow-y-scroll'>
                    <table className="w-full h-fit">
                        <thead className="bg-gray-50 border-b-2 border-gray-200 sticky top-0 divide-x divide-black">
                            <tr className='divide-x divide-gray-300 bg-[#cccccc36] select-none'>
