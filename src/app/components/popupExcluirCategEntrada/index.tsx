...
const PopupExcluirCategEntrada: React.FC<PopupProps> = ({ open, onClose, entradaNome, entradaId }) => {
    return (
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className='sm:w-[60%] md:w-[30%] w-full h-76 items-center bg-white z-20 p-3 rounded-xl'>
                    ...
                    <div className='flex justify-between mt-4'>
                        ...
                        <button
                            onClick={() => {
                                // Lógica para excluir a entrada com o ID: entradaId
                                console.log(`Excluir tipo com ID ${entradaId}`);
                            }}
                            title="Excluir"
...
export default PopupExcluirCategEntrada;
