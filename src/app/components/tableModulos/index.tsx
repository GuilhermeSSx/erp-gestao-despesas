                            ...
                            <td className='flex items-center justify-center text-gray-700 w-full'>
                                <div className="flex justify-center items-center w-full p-2 border-l border-blue-500">
                                    ...
                                    <select
                                        ...
                                        value={modulo.acesso} // Defina o valor do select com base no valor de acesso
                                        onChange={(e) => {
                                            const newAcesso = e.target.value;
                                            const updatedModulos = [...modulos];
                                            updatedModulos[index] = { ...modulo, acesso: newAcesso };
                                            onModuloSelected(updatedModulos[index]);
                                        }}
                                    >
