...
const PopupCriarCategSaida: React.FC<PopupProps> = ({ open, onClose }) => {
            ...
            <div className="flex flex-col items-center justify-center min-h-screen p-4">
                ...
                <div className='sm:w-[60%] md:w-[30%] w-full h-76 items-center bg-white z-20 p-3 rounded-xl'>
                    <div className=' rounded-lg w-full'>
                        <h2 className="text-xl font-bold text-center">Cadastrar categoria de saida</h2>
...
export default PopupCriarCategSaida;
