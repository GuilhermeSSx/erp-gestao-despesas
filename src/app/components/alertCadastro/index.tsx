        ...
        <AnimatePresence onExitComplete={() => setAnimationComplete(true)}>
            {open && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: -50 }}
                    className="fixed w-fit rounded-lg flex top-3 z-50"
                >

                    {
                        success ? (
                            <div className="bg-green-600 py-2 px-6 rounded-l-lg flex items-center">
                            ...
                            <div className="bg-red-600 py-2 px-6 rounded-l-lg flex items-center">
                    ...
                    <div className="px-4 py-2 bg-white rounded-r-lg flex justify-evenly items-center w-full border border-l-transparent border-gray-200 select-none">
                        ...
                        <button
                            onClick={onClose}
                            className="hover:bg-slate-200 flex items-center select-none "
                        >
